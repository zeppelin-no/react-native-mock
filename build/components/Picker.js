...
Picker=function(_React$Component){_inherits(Picker,_React$Component);function Picker(){var _ref;var _temp,_this,_ret;_classCallCheck(this,Picker);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=Picker.__proto__||Object.getPrototypeOf(Picker)).call.apply(_ref,[this].concat(args))),_this),_this.
propTypes={
children:_propTypes2['default'].node},_this.


statics={
Item:(0,_createMockComponent2['default'])('Picker.Item')},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(Picker,[{key:'render',value:function(){function render()


{
return null;
}return render;}()}]);return Picker;}(_react2['default'].Component);
