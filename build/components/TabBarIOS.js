...
statics={
Item:(0,_createMockComponent2['default'])('TabBarIOS.Item')},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(TabBarIOS,[{key:'render',value:function(){function render()


{
return null;
}return render;}()}]);return TabBarIOS;}(_react2['default'].Component);
